...
cmake -DZMQ_LOCAL_BUILD=ON -DENABLE_SWIG=ON -DCMAKE_BUILD_TYPE=Release %HELICS_PLATFORM% -DHELICS_BUILD_TESTS=OFF -DHELICS_BUILD_BOOST_TESTS=OFF -DCMAKE_PREFIX_PATH=%LIBRARY_PREFIX% -DCMAKE_INSTALL_PREFIX=%LIBRARY_PREFIX% %BUILD_PYTHON% ..
