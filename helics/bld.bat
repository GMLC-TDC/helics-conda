...
cmake -G"Ninja" -DCMAKE_BUILD_TYPE=Release %HELICS_PLATFORM% -DHELICS_BUILD_TESTS=OFF -DCMAKE_PREFIX_PATH=%LIBRARY_PREFIX% -DCMAKE_INSTALL_PREFIX=%SP_DIR%\helics\install ..
